...
int MPI_Allreduce(const void *sendbuf, void *recvbuf, int count,
  ...
  return NRM_MPI_INNER_NAME(MPI_Allreduce, sendbuf, recvbuf, count, datatype,
                            op, comm);
}

int MPI_Barrier(MPI_Comm comm) { return NRM_MPI_INNER_NAME(MPI_Barrier, comm); }
...
int MPI_Finalize(void) { return NRM_MPI_INNER_NAME(MPI_Finalize); }
